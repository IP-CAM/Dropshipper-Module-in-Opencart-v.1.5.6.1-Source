...
class ControllerCheckoutRegister extends Controller {
	...
	public function validate() {
		...
		if (!$json) {					
			if ((utf8_strlen($this->request->post['tax_id']) < 10) || (utf8_strlen($this->request->post['tax_id']) > 11)) {
			...
			if ((utf8_strlen($this->request->post['telephone']) < 10) || (utf8_strlen($this->request->post['telephone']) > 10) || !preg_match('/^\d{10}$/', $this->request->post['telephone']) ) {
