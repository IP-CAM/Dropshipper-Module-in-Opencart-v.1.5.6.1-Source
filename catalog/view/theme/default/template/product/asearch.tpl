...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="category-list">
    ...
    <ul>
      ...
      <li> <a class="smenu {dnd:'<?php echo $category['href'];?>', ajaxurl:'<?php echo $category['ajax_url'];?>', gapush:'no'}" rel="nofollow" href="javascript:void(0)"><?php echo $category['name']; ?> (<?php echo $category['total']; ?>)</a></li>
    ...
    <ul>
      ...
      <li> <a class="smenu {dnd:'<?php echo $categories[$i]['href'];?>', ajaxurl:'<?php echo $categories[$i]['ajax_url'];?>', gapush:'no'}" rel="nofollow" href="javascript:void(0)"><?php echo $categories[$i]['name']; ?> (<?php echo $categories[$i]['total']; ?>)</a></li>
...
//--></script><?php echo $ocscroll; ?><?php echo $footer; ?>