...
<div id="menuscm">
  ...
  <div class="box">
    <div id="filter_box" class="p_rel">
      ...
      <dl class="filters">
        ...
        <dd class="page_preload">
          <ul>
           ...
           foreach ($array_original as $key => $value) {$sort_order[$key] = $value['total'];}
             ...
             array_multisort($sort_order, SORT_DESC,$array_original);
              ...
              //slice array for present only values more important
      ...
      if ($values_selected) { ?>
      <?php foreach ($values_selected as $value_selected) {   $i==1 ? $liclass="first upper" : $liclass="upper";  ?>
      <dl class="filters">
        <?php if($value_selected['Tipo']=="PRICERANGE"){ ?>
        ...
        <dd>
          <div class="left" id="leftSlider">
            ...
            <a class="link_filter_del smenu {dnd:'<?php echo $value_selected['href'];?>',ajaxurl:'<?php echo $value_selected['ajax_url'];?>', gapush:'no'}" href="javascript:void(0)"  <?php echo $nofollow; ?> > <img src="image/supermenu/spacer.gif" alt="<?php echo $remove_filter_text; ?>" class="filter_del" /></a><br />
      ...
      <dd class="page_preload">
        <ul>
          ...
          <li class="active"><em>&nbsp;</em> <a class="link_filter_del smenu {dnd:'<?php echo $value_selected['href'];?>', ajaxurl:'<?php echo $value_selected['ajax_url'];?>', gapush:'no'}" href="javascript:void(0)" <?php echo $nofollow; ?>><img src="image/supermenu/spacer.gif" alt="<?php echo $remove_filter_text; ?>" class="filter_del" /></a> <span><?php echo $value_selected['name'];?> </span></li>
          <?php } ?>
          <?php if ($value_selected['see_more']){ ?>
          <li class="more_filters"><a href="javascript:void(0)" class="all_filters light small {dnd:'<?php echo $value_selected['see_more'];?>'}" rel="nofollow"><?php echo $see_more_text; ?></a></li>
          <?php } ?>
        </ul>
      </dd>
      </dl>
